/*================================================================
 *
 * seqPVmacros.h -- PV-related macros for development
 *     of EPICS State Notation Language (SNL) code
 *
...
#define DEBUG_PRINT2(DEBUG_LEVEL, MSG, _V1_, _V2_)    \
    if (debug_flag >= DEBUG_LEVEL) {		    \
        DEBUG_PRINT_HEADER (DEBUG_LEVEL);	  \
        printf(MSG, _V1_, _V2_);            \
        printf("\n");				                \
        epicsThreadSleep(0.01);			        \
    }
